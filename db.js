      ...
      if (menus && menus.length) {
        ...
        subMenuStmt.finalize(() => {
          ...
          const cards = [
            ...
            { menu: 'Container', title: 'SAP企业版', url: 'https://accounts.sap.com/oauth2/authorize?response_type=code&scope=openid+email+profile&redirect_uri=https%3A%2F%2Femea.cockpit.btp.cloud.sap%2Flogin%2Fcallback&client_id=28f1d77a-ce0d-401a-b926-e393cd8ed4fa&state=9onZatYlhx7G8ysrhQCS2A&code_challenge=t5Mp-sF2akcbj7d9vJLRFY8dnUJleGusmN8AOdqMiNE&code_challenge_method=S256', logo_url: 'https://accounts.sap.com/ui/public/cached/tenant/v/1/favicon', desc: 'SAP企业版登陆入口' },
            { menu: 'Container', title: 'SAP试用版', url: 'https://accounts.sap.com/oauth2/authorize?response_type=code&scope=openid+email+profile&redirect_uri=https%3A%2F%2Faccount.hanatrial.ondemand.com%2Flogin%2Fcallback&client_id=9868c363-bc2d-407f-bc14-2ef649230f6f&state=YQ1WSkMxiGFIE5SS8CTlug&code_challenge=a79-P3ArHzigPFsJ2NgF7C6MHim31qOTGvlaGFKWEsg&code_challenge_method=S256', logo_url: 'https://accounts.sap.com/ui/public/cached/tenant/v/1/favicon', desc: 'SAP试用版登陆入口' },
            ...
            // Tools
            { menu: 'Tools', title: 'Argo Tunnel json获取', url: 'https://fscarmen.cloudflare.now.cc', logo_url: 'data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200' viewBox='0 0 200 200'><defs><linearGradient id='grad1' x1='0%' y1='0%' x2='100%' y2='100%'><stop offset='0%' style='stop-color:%23ff5722; stop-opacity:1' /><stop offset='100%' style='stop-color:%23ff9800; stop-opacity:1' /></linearGradient><filter id='shadow' x='-20%' y='-20%' width='140%' height='140%'><feGaussianBlur in='SourceAlpha' stdDeviation='8' /><feOffset dx='5' dy='5' result='offsetblur' /><feFlood flood-color='rgba(0, 0, 0, 0.6)' /><feComposite in2='offsetblur' operator='in' /><feMerge><feMergeNode /><feMergeNode in='SourceGraphic' /></feMerge></filter></defs><rect width='100%' height='100%' fill='%23f5f5f5' /><text x='50%' y='50%' text-anchor='middle' dominant-baseline='middle' font-family='Arial, sans-serif' font-size='180px' fill='url(%23grad1)' font-weight='bold' filter='url(%23shadow)'>J</text></svg>', desc: 'cloudflared Argo Tunnel固定隧道json获取' },
            ...
            { subMenu: 'Free SMS', title: '7sim', url: 'https://7sim.net', logo_url: 'http://7sim.net/favicon.ico', desc: '' },
